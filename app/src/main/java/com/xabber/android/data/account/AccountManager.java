...
public class AccountManager implements OnLoadListener, OnWipeListener {
	...
	public String addAccount(String user, String password,
        ...
        System.out.println("!!!!!!!!!!!!!!entered in addAccount !!!!!!!!!!!!!!!"+accountType.getProtocol().isOAuth());
	...
	public String getNickName(String account) {
		...
		if ("".equals(result)) {
            String verboseName = getVerboseName(account);
            return verboseName.substring(0, verboseName.indexOf("@"));
        } else {
            return result;
        }
	}
